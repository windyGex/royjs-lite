...
class App extends React.Component {
    ...
    renderList() {
        ...
        return todoList.filter(filters[params.filter]).map((todo, index) => {
            return (
                <li className={{ completed: todo.completed }} key={index}>
                    <div className="view">
                        <input className="toggle" readOnly type="checkbox" checked={todo.completed} onClick={() => this.store.dispatch('complete', todo)} />
